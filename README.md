...
- **Nama Lengkap:** Mutia Ardelia Rokhima
- **NIM:** 240605110075
- **Dosen Pengampu:** A’la Syauqi M.Kom.
- **Proyek Akademik:** Proyek Aplikasi Blog (UAS Genap 2025/2026)
- **Tautan Video Demonstrasi (YouTube):** [Sistem Manajemen Blog (CMS)](https://youtu.be/RSOnt7oMGIs?si=-lmcMDsuV3Gq9ZFn)
...
- Pastikan aplikasi **XAMPP** (layanan Apache dan MySQL) sudah berjalan aktif.
